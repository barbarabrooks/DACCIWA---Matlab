...
for n=3:length(list)
    ...
    nc_create_empty(fc);
    %global attributes
    write_NC_header_LICOR_conc_v2(fc,meta,data);   
    %Dimensions
    write_NC_dimensions_LICOR_conc_v2(fc,meta,data);        
    %Variables
    write_NC_variables_LICOR_conc_v2(fc,data);
    %Data    
    write_NC_data_LICOR_conc_v2(fc,meta,data);
