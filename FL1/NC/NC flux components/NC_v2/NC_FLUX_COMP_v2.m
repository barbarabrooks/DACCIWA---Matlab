function NC_FLUX_COMP_v2(dn,do,fn_meta)
...
for n=3:length(list)
    ...
    nc_create_empty(fc);
    %global attributes
    write_NC_header_FLUX_COMP_v2(fc,meta,data);   
    %Dimensions
    write_NC_dimensions_FLUX_COMP_v2(fc,meta,data);        
    %Variables
    write_NC_variables_FLUX_COMP_v2(fc,data);
    %Data    
    write_NC_data_FLUX_COMP_v2(fc,meta,data);
