function NC_MRR_conc_v2(dn,do,fn_meta)
%dn='F:\WORKING\MRR\matlab_ave';
%do='F:\';
%fn_meta='C:\Users\lecbjb\Desktop\Data Project\Stationary\ncas-mrr-1\size-concentration-spectra\Example META Data File\Meta data.csv';
...
for n=3:length(list)
    ...
    nc_create_empty(fc);
    %global attributes
    write_NC_header_MRR_conc_v2(fc,meta,data);   
    %Dimensions
    write_NC_dimensions_MRR_conc_v2(fc,meta,data);        
    %Variables
    write_NC_variables_MRR_conc_v2(fc,meta,data);
    %Data    
    write_NC_data_MRR_conc_v2(fc,meta,data);
