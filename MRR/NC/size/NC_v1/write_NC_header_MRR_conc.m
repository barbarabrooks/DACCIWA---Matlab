function write_NC_header_MRR_profiles(fn_nc, meta, data)
    ...
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_4_description',meta.l46);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_4_assessment',meta.l47);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_5_description',meta.l48);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_5_assessment',meta.l49);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_6_description',meta.l50);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_6_assessment',meta.l51);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_7_description',meta.l52);
    nc_attput(fn_nc,netcdf.getConstant('NC_GLOBAL'),'qc_value_7_assessment',meta.l53);