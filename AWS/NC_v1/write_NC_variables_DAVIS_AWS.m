function write_NC_variables_DAVIS_AWS(fn_nc, data)
%time
        ts.Name='time';
        ts.Nctype='double';
...
%qc_flag_relative_humidity
 ...
 %qc_flag_wind
        ...
        dc=cell(1);dc{1}='time';ts.Dimension=dc;
        as(1).Name='units';as(1).Value='1';
        as(2).Name='long_name';as(2).Value='Data Qulaity flag: Winds';
        as(3).Name='valid_min';as(3).Value=1;
 ...
 %qc_flag_radiation
        ...
        dc=cell(1);dc{1}='time';ts.Dimension=dc;
        as(1).Name='units';as(1).Value='1';
        as(2).Name='long_name';as(2).Value='Data Qulaity flag: Radiation';
        as(3).Name='valid_min';as(3).Value=1;
