...
if fid>0
    ...
    while ~feof(fid)
       ...
       % if cc==94;meta.l54=temp;end;
       % if cc==95;meta.l55=temp;end;
       % if cc==96;meta.l56=temp;end;
       % if cc==97;meta.l57=temp;end;
       % if cc==98;meta.l58=temp;end;
       % if cc==99;meta.l59=temp;end;       
        if cc==94;meta.LAT=str2num(temp);end;
        if cc==95;meta.LON=str2num(temp);end;
        clear temp
    end
    fclose('all');
end
