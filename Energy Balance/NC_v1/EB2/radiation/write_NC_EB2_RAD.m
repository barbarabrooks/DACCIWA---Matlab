function write_NC_EB2_RAD(fn_nc,fn_data,fn_meta)
...
meta=get_meta_EB2_RAD(fn_meta);

%create nc file, assumes NC_CLOBBER
    nc_create_empty(fn_nc);
%global attributes
    write_NC_header_EB2_RAD(fn_nc,meta,data);   
%Dimensions
    write_NC_dimensions_EB2_RAD(fn_nc,meta,data);        
%Variables
    write_NC_variables_EB2_RAD(fn_nc,data);
%Data    
    write_NC_data_EB2_RAD(fn_nc,meta,data);
