function NC_SODAR_v2(dn,do,fn_meta)
%dn='F:\WORKING\sodar\matlab';
%do='F:\';
%fn_meta='C:\Users\lecbjb\Desktop\Data Project\Stationary\ncas-sodar-3\Example META Data File\Meta data.csv';
...
for n=3:length(list)
    ...
    nc_create_empty(fc);
    %global attributes
    write_NC_header_SODAR_v2(fc,meta,data);   
    %Dimensions
    write_NC_dimensions_SODAR_v2(fc,meta,data);        
    %Variables
    write_NC_variables_SODAR_v2(fc,meta,data);
    %Data    
    write_NC_data_SODAR_v2(fc,meta,data);
