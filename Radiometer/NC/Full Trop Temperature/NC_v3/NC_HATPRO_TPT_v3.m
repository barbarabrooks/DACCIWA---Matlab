function NC_HATPRO_TPT_v3(dn,do,fn_meta)
...
%BB 24/06/2017
%fn_meta='E:\ACSE - radiometer\meta\full-troposphere-temperature-profiles\ACSE_meta_full_trop_v2.txt';
%dn='E:\ACSE - radiometer\matlab';
%do='E:\ACSE - radiometer\NC\V1\full-tropsphere-temperature-profiles';
%get meat data
...
for n=3:length(list)
   %get file time stamp
    ...
    if ~isempty(data.TPC)
        ...
        %Dimensions
        write_NC_dimensions_HATPRO_TPT_v3(fc,meta,data);        
        %Variables - General - generic function
        write_NC_variables_general_v3(fc,meta,data);
        %Variables - specific - specific function
        write_NC_variables_specific_HATPRO_TPT_v3(fc, meta);
        %Data    
        write_NC_data_HATPRO_TPT_v3(fc,meta,data);
    end
