function NC_Wrapper_HATPRO_TPT(dn,do,fn_meta)
...
f1='ncas-scanning-radiometer-1_';
f4='full-troposphere-temperature-profiles_';
f6='.nc';
...
for n=3:length(list)
    ...
    write_NC_HATPRO_TPT(fullfile(do,fc),fullfile(dn,list(n).name),fn_meta);
    clear fc temp ix f3
end
