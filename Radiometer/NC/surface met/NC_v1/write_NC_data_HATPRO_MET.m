function write_NC_data_HATPRO_MET(fn_nc, meta, data)
%get rid of NaN
...
%Save data
    ...
    nc_varput(fn_nc,'surface_air_pressure',data.PP.*100);
    nc_varput(fn_nc,'air_temperature',data.T);% temperatur in C in files
