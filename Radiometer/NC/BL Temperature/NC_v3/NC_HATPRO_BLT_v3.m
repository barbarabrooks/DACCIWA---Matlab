function NC_HATPRO_BLT_v3(dn,do,fn_meta)
...
%BB 24/06/2017
%fn_meta='E:\ACSE - radiometer\meta\boundary-layer-temeprature-profiles\ACSE_meta_bound_lay_temp_v2.txt';
%dn='E:\ACSE - radiometer\matlab';
%do='E:\ACSE - radiometer\NC\V1\boundary-layer-temperature-profiles';
%get meat data
...
for n=3:length(list)
    ...
    if ~isempty(data.TPB)
        ...
        %Dimensions
        write_NC_dimensions_HATPRO_BLT_v3(fc,meta,data);        
        %Variables - General - generic function
        write_NC_variables_general_v3(fc,meta,data);
        %Variables - specific - specific function
        write_NC_variables_specific_HATPRO_BLT_v3(fc,meta);
        %Data    
        write_NC_data_HATPRO_BLT_v3(fc,meta,data);
    end
