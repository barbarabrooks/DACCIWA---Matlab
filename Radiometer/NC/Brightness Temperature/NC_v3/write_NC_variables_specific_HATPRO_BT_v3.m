function write_NC_variables_specific_HATPRO_BT_v3(fn_nc)
%radaition_frequency
        ...
        as(5).Name='valid_min';as(5).Value=2.2e+10;
        as(6).Name='valid_max';as(6).Value=5.8e+10;
        ts.Attribute=as;
...
%brightness_temperature
        ...
        as(6).Name='valid_max';as(6).Value=350;
