function write_NC_data_HATPRO_BT_v3(fn_nc, meta, data)
...
%Save data
    ...
    nc_varput(fn_nc,'radiation_frequency',data.FREQ);
    
    nc_varput(fn_nc,'brightness_temperature',data.BRT);
