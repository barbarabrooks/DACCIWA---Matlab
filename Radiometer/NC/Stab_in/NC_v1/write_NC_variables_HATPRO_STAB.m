function write_NC_variables_HATPRO_STAB(fn_nc, data)
%time
        ts.Name='time';
        ts.Nctype='double';
...
%lifted_index
        ...
        as(4).Name='valid_min';as(4).Value=min(data.LI);
        as(5).Name='valid_max';as(5).Value=max(data.LI);
...
%modified_k_index
        ...
        as(3).Name='_FillValue';as(3).Value=-1e+020;
        as(4).Name='valid_min';as(4).Value=min(data.KOI);
        as(5).Name='valid_max';as(5).Value=max(data.KOI);
        as(6).Name='cell_methods';as(6).Value='time: mean';
        as(7).Name='coordinates';as(7).Value='latitude longitude';
        ts.Attribute=as;
        nc_addvar(fn_nc,ts);clear ts as dc
%atmosphere_stability_total_totals_index
        ...
        as(5).Name='valid_min';as(5).Value=min(data.TTI);
        as(6).Name='valid_max';as(6).Value=max(data.TTI);
...
%atmosphere_stability_k_index
        ...
        as(4).Name='_FillValue';as(4).Value=-1e+020;
        as(5).Name='valid_min';as(5).Value=min(data.KI);
        as(6).Name='valid_max';as(6).Value=max(data.KI);
        as(7).Name='cell_methods';as(7).Value='time: mean';
        as(8).Name='coordinates';as(8).Value='latitude longitude';
        ts.Attribute=as;
        nc_addvar(fn_nc,ts);clear ts as dc
%atmosphere_stability_showalter_index
        ...
        as(4).Name='_FillValue';as(4).Value=-1e+020;
        as(5).Name='valid_min';as(5).Value=min(data.SI);
        as(6).Name='valid_max';as(6).Value=max(data.SI);
        as(7).Name='cell_methods';as(7).Value='time: mean';
        as(8).Name='coordinates';as(8).Value='latitude longitude';
        ts.Attribute=as;
        nc_addvar(fn_nc,ts);clear ts as dc
%atmosphere_convective_available_potential_energy
        ...
        as(3).Name='_FillValue';as(3).Value=-1e+020;
        as(4).Name='valid_min';as(4).Value=min(data.CAPE);
        as(5).Name='valid_max';as(5).Value=max(data.CAPE);
        as(6).Name='cell_methods';as(6).Value='time: mean';
        as(7).Name='coordinates';as(7).Value='latitude longitude';
        ts.Attribute=as;
        nc_addvar(fn_nc,ts);clear ts as dc
