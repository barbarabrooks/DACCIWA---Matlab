function NC_HATPRO_IWVLWP_v3(dn,do,fn_meta)
...
%BB 24/06/2017
%fn_meta='E:\ACSE - radiometer\meta\iwv-lwp\ACSE_meta_iwv_lwp_v2.txt';
%dn='E:\ACSE - radiometer\matlab';
%do='E:\ACSE - radiometer\NC\V1\iwv-lwp';
...
for n=3:length(list)
   %get file time stamp
    ...
    %Dimensions
    write_NC_dimensions_HATPRO_IWVLWP_v3(fc,meta,data); 
    %Variables - General - generic function
    write_NC_variables_general_v3(fc,meta,data);
    %Variables - specific - specific function
    write_NC_variables_specific_HATPRO_IWVLWP_v3(fc);
    %Data    
    write_NC_data_HATPRO_IWVLWP_v3(fc,meta,data);
