function NC_RAPID_SONDES_v2(dn,do,fn_meta)
%dn='F:\WORKING\Sondes\matlab';
%do='F:\';
%fn_meta='C:\Users\lecbjb\Desktop\Data Project\Stationary\ncas-rapidsonde-2\Example META Data File\Meta data.csv';
...
for n=3:length(list)
    ...
    nc_create_empty(fc);
    %global attributes
    write_NC_header_RAPID_SONDES_v2(fc,meta,data);   
    %Dimensions
    write_NC_dimensions_RAPID_SONDES_v2(fc,data);        
    %Variables
    write_NC_variables_RAPID_SONDES_v2(fc,data);
    %Data    
    write_NC_data_RAPID_SONDES_v2(fc,data);
