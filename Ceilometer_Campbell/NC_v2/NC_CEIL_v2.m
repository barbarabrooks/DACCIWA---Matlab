function NC_CEIL_v2(dn,do,fn_meta)
%dn='E:\WORKING\Ceilometer\matlab';
%do='E:\';
%fn_meta='C:\Users\lecbjb\Desktop\Data Project\Stationary\ncas-ceil-1\Example META Data File\Meta data.csv';
...
for n=3:length(list)
    ...
    nc_create_empty(fc);
    %global attributes
    write_NC_header_CEIL_v2(fc,meta,data);   
    %Dimensions
    write_NC_dimensions_CEIL_v2(fc,meta,data);        
    %Variables
    write_NC_variables_CEIL_v2(fc,meta,data);
    %Data    
    write_NC_data_CEIL_v2(fc,meta,data);
